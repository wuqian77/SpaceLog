...
void JSRM_qwu(int* NN, int * PP, float * L1, float * L2, float * L3, float *Y_data, float *sigma_sr, int * N_iter,
...
printf("\n\nThe elements in the beta_new are: \n\n") ;
  for(i = 0 ; i < 4 ; i++){
    for(j = 0 ; j < 4 ; j++){
      printf("%f", beta_new[i*p+j]) ;
      printf("\t");
    }
    printf("\n");
  }
...
/////////////////////// Equation (4)-(6)
 ...
 for(k=0; k<n; k++)
   ...
   ///printf("%d",printMatrice(beta_new));
   printf("\n\nThe elements in the Yhat are: \n\n") ;
 for(i = 0 ; i < 4 ; i++){
   for(j = 0 ; j < 4 ; j++){
     printf("%f", Yhat_m[i*p+j]) ;
     printf("\t");
   }
   printf("\n");
 }

 printf("\n\nThe elements in the E_m are: \n\n") ;
 for(i = 0 ; i < 4 ; i++){
   for(j = 0 ; j < 4 ; j++){
     printf("%f", E_m[i*p+j]) ;
     printf("\t");
...
///////////////////////// Step 2: update one beta  //////////////////////////////
  ...
  ///////// Get active Set;
     ...
     printf("number of |beta_new_0| > eps1    ");
     printf("%d", k);

     printf("\n\nThe elements in the pick at step 2 are: \n\n") ;
     for(i = 0 ; i < nbeta ; i++){
       for(j = 0 ; j < 2 ; j++){
         printf(" %d ", pick[i*2+j]) ;
         printf("\t");
 ...
 if(k>0) //otherwise, converge to 0 at the initial step.
 {
  ...
  //////// Equation (10)
     ...
     printf("\n\nbeta_old\n\n    ");
     printf("%f", beta_old[cur_i*p+cur_j]);
      ...
      if(temp < 0 )
      ...
      else
        {
         ...
         if(temp1 < 0 )
          ...
          printf("\n\nThe elements in the beta_change are: \n\n") ;
          printf("%f", beta_change) ;
          printf("\n");

          printf("\n\nThe elements in the beta_new at step 2 are: \n\n") ;
          printf("%f", beta_new[cur_i*p+cur_j]) ;
          printf("\n");

          printf("\n\n threshold at step 2 are: \n\n") ;
          printf("%f", threshold) ;
          printf("\n");
 ...
 ///Yhat_m[k*p+j]=Yhat_m[k*p+j]+Y_m[k*p+i]*beta_new[i*p+j]*B[i*p+j];
    ...
    printf("\n\nThe elements in the beta_change are: \n\n") ;
    printf("%f", beta_change);
    printf("\n\nThe elements in the change_i are: \n\n") ;
    printf("%d", change_i);
    printf("\n\nThe elements in the change_j are: \n\n") ;
    printf("%d", change_j);
    ...
    //////////// Equation (12)
     ...
     printf("\n\nThe elements in the cur_i are: \n\n") ;
     printf("%d", cur_i);
     printf("\n\nThe elements in the cur_j are: \n\n") ;
     printf("%d", cur_j);
    ...
    ///shrink beta_next
     ...
     iter_count=iter_count+1 ;
          ...
          printf("\n\nThe elements in the beta_old are: \n\n") ;
          printf("%f", beta_old[cur_i*p+cur_j]) ;
          printf("\n");

          printf("\n\nThe elements in the beta_next are: \n\n") ;
          printf("%f", beta_next) ;
          printf("\n");
          ...
          printf("\n\nThe elements in the beta_new are: \n\n") ;
          printf("%f", beta_new[cur_j*p+cur_i]) ;
          printf("\n");
